...
*before* they join; joining is a signed transaction referencing the rule set hash.
...
1. Win percentage
2. **Points For**
3. Head-to-head record — *skipped unless the tied teams played an equal number of times*
4. Points Against
5. Lowest team ID
...
Bots neither vote nor trade. The threshold is one third of *uninvolved* teams, matching
